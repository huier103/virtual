...
//#include "COMMON/platform_constants.h"//..wanlin
...
// // RadioResourceConfigCommonSIB_t *radioResourceConfigCommon;//..wanlin此处因为头文件包含原因，被注释
//  /// pointer to RRC PHY configuration 
//  struct PhysicalConfigDedicated *physicalConfigDedicated;
//  /// pointer to TDD Configuration (NULL for FDD)
// // TDD_Config_t *tdd_Config;//..wanlin
//  /// Pointer to RRC MAC configuration
// // MAC_MainConfig_t *macConfig;//..wanlin
//  /// Pointer to RRC Measurement gap configuration
// // MeasGapConfig_t  *measGapConfig;//..wanlin
//  /// Pointers to LogicalChannelConfig indexed by LogicalChannelIdentity. Note NULL means LCHAN is inactive.
// // LogicalChannelConfig_t *logicalChannelConfig[MAX_NUM_LCID];//..wanlin
