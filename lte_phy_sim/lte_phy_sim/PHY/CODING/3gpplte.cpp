...
__inline void threegpplte_interleaver_reset() {
  threegpplte_interleaver_output = 0;
  threegpplte_interleaver_tmp    = 0;
}

__inline unsigned short threegpplte_interleaver(unsigned short f1,
					      unsigned short f2,
					      unsigned short K) {
...
__inline unsigned char threegpplte_rsc(unsigned char input,unsigned char *state) {
...
__inline void threegpplte_rsc_termination(unsigned char *x,unsigned char *z,unsigned char *state) {
...
__inline short threegpp_interleaver_parameters(unsigned short bytes_per_codeword) {
