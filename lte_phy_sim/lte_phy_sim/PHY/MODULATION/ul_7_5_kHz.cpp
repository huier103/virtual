...
#ifndef __SSE3__
__m128i zero_7_5;
#define _mm_abs_epi16(xmmx) _mm_xor_si128((xmmx),_mm_cmpgt_epi16(zero_7_5,(xmmx)))
#define _mm_sign_epi16(xmmx,xmmy) _mm_xor_si128((xmmx),_mm_cmpgt_epi16(zero_7_5,(xmmy)))
#endif
__declspec(align(16))short conjugate75[8]= {-1,1,-1,1,-1,1,-1,1} ;
__declspec(align(16))short conjugate75_2[8]= {1,-1,1,-1,1,-1,1,-1} ;
__declspec(align(16))short negate[8]= {-1,-1,-1,-1,-1,-1,-1,-1};
