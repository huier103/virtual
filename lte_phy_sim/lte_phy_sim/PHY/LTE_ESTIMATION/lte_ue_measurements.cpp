...
#include "tmmintrin.h"
#else
__declspec(align(16))__m128i zeroPMI;
...
//((200*phy_vars_ue->PHY_measurements.rsrq[eNB_offset]) + ((1024-200)*100*phy_vars_ue->PHY_measurements.rsrp[eNB_offset]*phy_vars_ue->lte_frame_parms.N_RB_DL/phy_vars_ue->PHY_measurements.rssi))>>10;
    ...
    msg("[PHY][UE %d] Frame %d, slot %d rsrp[%d] %3.1f dBm, rsrp2[%d] %3.1f, rssi %3.1f dBm, rsrq %2.1f dB \n",
	   ...
	   eNB_offset,
	   (10*log10((double)phy_vars_ue->PHY_measurements.rx_spatial_power[eNB_offset][0][0])/10.0)-phy_vars_ue->rx_total_gain_dB-dB_fixed(phy_vars_ue->lte_frame_parms.N_RB_DL*12)-6.02,
	   ...
	   (10*log10((double)phy_vars_ue->PHY_measurements.rsrq[eNB_offset]))-20);
