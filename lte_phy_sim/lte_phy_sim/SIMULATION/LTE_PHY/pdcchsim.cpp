...
#define BCCH_RB_ALLOC computeRIV(PHY_vars_eNB->lte_frame_parms.N_RB_UL,0,3)
#define RA_RB_ALLOC computeRIV(PHY_vars_eNB->lte_frame_parms.N_RB_UL,0,3)
...
DCI1A_5MHz_TDD_1_6_t  DLSCH_alloc_pdu1E;
...
//  mac_xface->computeRIV = computeRIV;
  ...
  for (SNR=snr0;SNR<snr1;SNR+=1) {
	...
	multipath_channel(eNB2UE,s_re,s_im,r_re,r_im,
      ...
      //N0W          = -95.87;
      sigma2_dB = (double)tx_lev_dB +10*log10((double)PHY_vars_eNB->lte_frame_parms.ofdm_symbol_size/300) - SNR;
      if (n_frames==1)
